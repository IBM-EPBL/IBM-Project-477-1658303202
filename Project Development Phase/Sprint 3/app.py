...
model = keras.models.load_model('83_per_dignat.h5')
...
def modelfun(filename):
    ...
    desc_data = pd.read_excel(r'E:\IBM\Backend\IBM_classes.xlsx')
    ...
    if pred_name in model_class_names:
        ...
        out_dict = {'Name':outp['COMMON NAME'][0].casefold().capitalize(), 'Scientific_Name':outp['SCIENTIFIC NAME'][0].casefold().capitalize(), 'Class':outp['CLASS'][0].casefold().capitalize(),'Descriprion':outp['DESCRIPTION'][0]}
        return out_dict
    else:
        return "Not found"
...
def upload_image():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('upload.html',model_out=model_out)
    else:
